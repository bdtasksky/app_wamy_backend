...
class ThemeController extends Controller
{
    ...
    public function updateColors(Request $request)
    {
        ...
        if ($theme) {
            ...
            $theme->hero_description = $request->input('hero_description');
            $theme->is_default = 0;
    ...
    public function resetThemeSettings()
    {
        ...
        if ($activeTheme && !$activeTheme->is_default) {
            ...
            $activeTheme->hero_title = $activeTheme->name === 'Wordcraft' ? localize('hero_title_content') : null;
            $activeTheme->hero_description = $activeTheme->name === 'Wordcraft' ? localize('hero_description_content') : null;
