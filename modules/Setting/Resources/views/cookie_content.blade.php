            ...
            <div class="table_customize">
                <form action="{{ route('cookie.content.update') }}" method="POST">
                    ...
                    <div class="form-check form-switch mb-4 d-flex align-items-center">
                        <input type="checkbox" class="form-check-input auto-post-checkbox me-2" id="show_cookie" name="show_cookie" value="1"
                            {{ old('show_cookie', $cookieInfo->show_cookie ?? false) ? 'checked' : '' }}>
                        <label class="form-check-label" for="show_cookie">
                            {{ localize('show_cookie_alert') }}
                        </label>
                    </div>
