                        ...
                        <div class="col-md-8 col-12">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="permalink" class="col-form-label">{{ localize('Permalink Structure') }}</label>
                                        <select name="permalink" id="permalink" class="form-control select-basic-single" required>
                                            <option value="default" {{ $app->permalink == 'default' ? 'selected' : '' }}>
                                                {{ localize('Default') }} – /any-slug
                                            </option>
                                            <option value="category" {{ $app->permalink == 'category' ? 'selected' : '' }}>
                                                {{ localize('Category') }} – /category/any-slug
                                            </option>
                                            <option value="date" {{ $app->permalink == 'date' ? 'selected' : '' }}>
                                                {{ localize('Date-based') }} – /YYYY/MM/DD/any-slug
                                            </option>
                                        </select>
                                    </div>
                                </div>
