...
function addCartOfAccount(coaID) {
    ...
    var url = baseurl + '/admin/accounts/get/detail/' + coaID;
    accLoader();
    $.ajax({
        type: 'GET',
        url: url,
        ...
        success: function (data) {
            ...
            if ((data.coaDetail.head_level == 1)  &&
                (data.coaDetail.parent_id == 0)) {
            ...
            if (data.coaDetail.head_level == 1 ||
                (data.coaDetail.head_level == 2) ||
                (data.coaDetail.head_level == 3)) {
                checkUpdeate(data);
            }
...
function addLoadFromForAll(allfromLoad) {
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3) && (Number(allfromLoad.coaDetail.acc_type_id) == 1)) {
        ...
        //Assect radio button start
        addFrom += "<div class='row mt-2'>";
        addFrom += "<label for='asset_type' class='col-form-label col-sm-4 col-md-12 col-xl-4 fw-semibold'>Asset Type</label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";


        addFrom += "<input class='form-check-input  m-1' type='radio' name='asset_type' value='is_stock' id = 'asset_is_stock' >";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3) && ((Number(allfromLoad.coaDetail.acc_type_id) == 2) || (Number(allfromLoad.coaDetail.acc_type_id) == 3))) {
        ...
        $.each(acSubtypeExpense, function (key, evalue) {
            addFrom += "<option value = '" + evalue.id + "'>" + evalue.name + "</option>";
        });
        addFrom += "</select>";
        addFrom += "</div>";
        addFrom += "</div>";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3) && ((Number(allfromLoad.coaDetail.acc_type_id) == 4) || (Number(allfromLoad.coaDetail.acc_type_id) == 5))) {
        ...
        $.each(acSubtypele, function (key, levalue) {
            addFrom += "<option value = '" + levalue.id + "'>" + levalue.name + "</option>";
        });
        addFrom += "</select>";
        addFrom += "</div>";
        addFrom += "</div>";
    ...
    if ((Number(allfromLoad.coaDetail.head_level) == 3)){
        addFrom += "<div class='col-md-12 mt-3'>";
        addFrom += "<div class='row mt-2'>";
        addFrom += "<label for='bed_no' class='col-form-label col-sm-4 col-md-12 col-xl-4 fw-semibold required'>Wallet Status</label>";
        addFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";

        addFrom += "<input class='form-check-input m-1' type='checkbox' name='wallet_status' value='is_wallet' id='is_wallet'>";
        addFrom += "<label class='form-check-label' for='is_wallet'>Is Wallet</label>";
...
function checkUpdeate(data) {
    ...
    var editurl = baseurl + '/admin/accounts/' + editcoaId + '/edit';
...
function loadUpdatefrom(UpdateCoaData) {
    ...
    updateFrom += "<input class='form-check-input m-1' type='radio' name='is_active' value='1' id='is_active' " + (UpdateCoaData.coaDetail.is_active == 1 ? "checked" : "") + " >";
    updateFrom += "<label class='form-check-label' for='is_active'>Active</label>";
    updateFrom += "<input class='form-check-input m-1' type='radio' name='is_active' value='0' id='is_active' " + (UpdateCoaData.coaDetail.is_active == 0 ? "checked" : "") + " >";
    ...
    //radio button End
        ...
        updateFrom += "<input type='hidden' class='form-control' id='current_head_level' name='current_head_level' value = '" + currentHeadLabel + "' required>";
    }

    if ((Number(UpdateCoaData.coaDetail.head_level) == 3)){
        updateFrom += "<div class='col-md-12 mt-3'>";
        updateFrom += "<div class='row mt-2'>";
        updateFrom += "<label for='bed_no' class='col-form-label col-sm-4 col-md-12 col-xl-4 fw-semibold required'>Wallet Status</label>";
        updateFrom += "<div class='col-sm-8 col-md-12 col-xl-8 mt-2'>";

        updateFrom += "<input class='form-check-input m-1' type='checkbox' name='wallet_status' value='is_wallet' id='is_wallet' " + (UpdateCoaData.coaDetail.is_wallet == 1 ? "checked" : "") + ">";
        updateFrom += "<label class='form-check-label' for='is_wallet'>Is Wallet</label>";
    ...
    if ((Number(UpdateCoaData.coaDetail.head_level) == 4) && (Number(UpdateCoaData.coaDetail.acc_type_id) == 1)) {
        ...
        updateFrom += "<br><input class='form-check-input m-1' type='checkbox' name='wallet_status' value='is_wallet' id='is_wallet' " + (UpdateCoaData.coaDetail.is_wallet == 1 ? "checked" : "") + ">";
        updateFrom += "<label class='form-check-label' for='is_wallet'>Is Wallet</label>";
        ...
        if (UpdateCoaData.coaDetail.subtype_id != null) {
            ...
            $.each(editacSubtype, function (key, editvalue) {
                if (UpdateCoaData.coaDetail.subtype_id == editvalue.id) {
                    updateFrom += "<option value = '" + editvalue.id + "' selected>" + editvalue.name + "</option>";
                }
                else {
                    updateFrom += "<option value = '" + editvalue.id + "'>" + editvalue.name + "</option>";
                }
        ...
        if (UpdateCoaData.coaDetail.subtype_id != null) {
            ...
            $.each(editEIacSubtype, function (key, editIEvalue) {
                if (UpdateCoaData.coaDetail.subtype_id == editIEvalue.id) {
                    updateFrom += "<option value = '" + editIEvalue.id + "' selected>" + editIEvalue.name + "</option>";
                }
                else {
                    updateFrom += "<option value = '" + editIEvalue.id + "'>" + editIEvalue.name + "</option>";
                }
        ...
        if (UpdateCoaData.coaDetail.subtype_id != null) {
            ...
            $.each(editELacSubtype, function (key, editELvalue) {
                if (UpdateCoaData.coaDetail.subtype_id == editELvalue.id) {
                    updateFrom += "<option value = '" + editELvalue.id + "' selected>" + editELvalue.name + "</option>";
                }
                else {
                    updateFrom += "<option value = '" + editELvalue.id + "'>" + editELvalue.name + "</option>";
                }
    ...
    updateFrom += "<div class='col-md-12'>";
    updateFrom += "<div class='row'>";
    if (Number(UpdateCoaData.coaDetail.head_level) == 4 && currentHeadLabel != 1) {
        updateFrom +=
        ...
        updateFrom +=
            ...
            ")'>Create</a>";
        if (currentHeadLabel != 1) {
            updateFrom +=  "<a class='btn btn-danger mx-2' onclick='loadDelfrom(" +
                stringifiedObj +
                ")'>Delete</a></div>";
        }
    }
