"use strict";
    ...
    var row = parseInt($("#countstart").val());
    ...
    if (count == limits) alert("You have reached the limit of adding " + count + " inputs");
        ...
        //   count = count++;
          ...
          var row = parseInt($("#countstart").val(count));
