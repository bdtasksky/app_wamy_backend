...
<script src="{{ module_asset('Accounts/js/reports/profit_loss_report_search_script.js') }}" type="text/javascript"></script>
{{-- <script src="{{ module_asset('Accounts/js//canvas-pdf/jspdf.min.js') }}" type="text/javascript"></script> --}}
