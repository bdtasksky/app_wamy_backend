                            ...
                            @foreach ($ledger_data as $key => $l_data)
                                ...
                                <tr class="{{ ($loop->iteration % 2) == 0 ? '' : 'voucherList' }}">
                                    ...
                                    <td style="background:{{ $style }}" align="center">
                                        <a href="javascript:void(0);" data-id="{{ $l_data->v_voucher_id }}" data-vdate="{{ $l_data->v_date }}" class="v_view" style="margin-right:10px" title="View Voucher">
                                            {{ $l_data->v_voucher_no }}
                                        </a>
                                    </td>
                                    ...
                                    <td style="background:{{ $style }}" align="left">
                                        <strong>
                                            @if ($l_data->v_voucher_type_id != 0)
                                                @php
                                                    $vtype = array_search($l_data->v_voucher_type_id, $vouchartypes);
                                                @endphp
                                                {{ $vtype }}
                                            @else
                                                {{ '' }}
