        ...
        <div class="card">
            <div class="card-header">
                <div class="card-title">
                    <h5>{{ __('language.balance_sheet') }}</h5>
                </div>
            </div>
                ...
                <form action="{{ route('account.report.balance.sheet.report.search') }}" method="post" class="form-inline">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-5 row-cols-xxl-6 g-3 align-items-end">
                            ...
                            <div class="col form-group form-group-new">
                                ...
                                <input type="text" name="dtpFromDate" value="{{ $financialyears->start_date ?? '' }}" class="form-control" id="from_date" />
                            </div>

                            <div class="col form-group form-group-new">
                                <label for="dtpToDate">{{ __('language.to_date') }} :</label>
                                <input type="text" class="form-control" name="dtpToDate" value="{{ $financialyears->end_date ?? '' }}" id="to_date" />
                            </div>

                            <div class="col-sm-4 form-group form-group-new mt-4">
                                <div class="i-check">
                                    <input tabindex="8" type="radio" id="t_shape" name="type" value="0" >
                                    <label for="t_shape">{{ __('language.t_shape') }}</label>
        
                                    <input tabindex="7" type="radio" id="with_cogs" name="type" value="1"  checked>
                            ...
                            {{-- <div class="col form-group form-group-new">
                                <div class="d-flex align-items-center gap-3">
                                    <div>
                                        <input type="checkbox" id="t_shape" name="t_shape" value="1" @if(old('t_shape') == 1) checked @endif>
                                    <label for="t_shape">{{ __('language.t_shape') }}</label>
                                    </div>
                                    <div>
                                        <input type="checkbox" id="with_cogs" name="with_cogs" value="1" checked >
                                        <label for="with_cogs">{{ __('language.with_COGS') }}</label>
                                    </div>
                                </div>
                            </div> --}}
