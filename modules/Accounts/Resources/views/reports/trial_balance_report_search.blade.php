                                    ...
                                    @if($arr_key)
                                        ...
                                        @else
                                            <tr>
                                                ...
                                                <td style=" background: #22376d!important ; color:#fff;text-align:right;">{{ $t_b_data[0]->debit }}</td>
                                                <td style=" background: #22376d!important ; color:#fff;text-align:right;">{{ $t_b_data[0]->credit }}</td>
                                            </tr>
                                        @endif
                                @endforeach
                            </tbody>
