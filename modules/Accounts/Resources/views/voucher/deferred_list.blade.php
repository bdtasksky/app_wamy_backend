...
@section('title', __('language.deferred_list'))
@push('css')
@endpush
@section('content')
...
<div class="card mb-4">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h6 class="fs-17 fw-semi-bold mb-0">{{ __('language.deferred_vouchers') }}</h6>
            </div>
            <div class="text-end">
                <div class="actions">
                    @can('accounts.read')
                        <div class="form-group">
                            <a href="{{ route('accounts.voucher.deferredReport') }}" class="btn btn-primary btn-md pull-right">
                                <i class="fa fa-file" aria-hidden="true"></i> {{ __('language.deferred_report') }}
                            </a>
                            <a href="{{ route('accounts.voucher.deferred_schedule') }}" class="btn btn-primary btn-md pull-right">
                                <i class="fa fa-file" aria-hidden="true"></i> {{ __('language.deferred_schedule') }}
                            </a>
                        </div>
                    @endcan
                </div>
...
<!-- Bootstrap Modal -->
<div class="modal fade" id="attachmentModal" aria-hidden="true">
...
<script>
    window.appData = {
        getListUrl: "{{ route('accounts.voucher.getDeferredList') }}",
...
<script src="{{ module_asset('Accounts/js/deferred-voucher.js?v=' . time()) }}"></script> <!-- Your custom script -->
<script>
