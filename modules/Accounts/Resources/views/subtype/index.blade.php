...
@section('title', __('language.account_subType_list'))
@push('css')
    ...
    <div class="card mb-4 fixed-tab-body">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="fs-17 fw-semi-bold mb-0">{{ __('language.account_subType_list') }}</h6>
                </div>
                <div class="text-end">
                    <div class="actions">
                        ...
                        @can('create_subtype')
                            <a href="#" class="btn btn-success btn-sm" data-bs-toggle="modal"
                                data-bs-target="#create-subtype"><i
                                    class="fa fa-plus-circle"></i>&nbsp;{{ __('language.add_subtype') }}</a>
...
@push('js')
    ...
    <script src="{{ asset('modules/Accounts/Resources/assets/js/subtype.js?v=2') }}"></script>
@endpush
