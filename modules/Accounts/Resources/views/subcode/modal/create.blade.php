                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group mb-2 mx-0 row">
                            ...
                            <div class="col-lg-9">
                                <select name="acc_subtype_id" required class="form-select">
                        ...
                        <div class="form-group mb-2 mx-0 row">
                            ...
                            <div class="col-lg-9">
                                <input type="text" required name="name" placeholder="{{ __('language.name') }}" class="form-control"  autocomplete="off">
                          </div>
                        </div>
