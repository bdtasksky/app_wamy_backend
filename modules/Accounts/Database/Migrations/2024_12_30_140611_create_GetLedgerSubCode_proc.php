...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::unprepared("CREATE PROCEDURE `GetLedgerSubCode`(IN `p_branch_Id` INT, IN `p_acc_coa_id` INT, IN `subCode_id` INT, IN `p_from_date` DATE, IN `p_to_date` DATE)
BEGIN
...
END");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS GetLedgerSubCode");
    }
};
