...
class WebLayout extends Component
{
    ...
    public $seoSchemasInfo, $breadcrumbInfo, $brdcVideoInfo, $videoSchemasInfo, $opinionSchemasInfo, $brdcArchiveInfo, $brdcRssInfo, $rssSchemasInfo;

    /**
     * Summary of __construct
     * @param \App\Services\HomeDataService $homeDataService
     */
    public function __construct(HomeDataService $homeDataService, $seoSchemasInfo = null, $breadcrumbInfo = null, $brdcVideoInfo = null, $videoSchemasInfo = null, $opinionSchemasInfo = null, $brdcArchiveInfo = null, $brdcRssInfo = null, $rssSchemasInfo = null)
    {
        $this->homeDataService = $homeDataService;
        $this->seoSchemasInfo = $seoSchemasInfo;
        $this->breadcrumbInfo = $breadcrumbInfo;
        $this->brdcVideoInfo = $brdcVideoInfo;
        $this->videoSchemasInfo = $videoSchemasInfo;
        $this->opinionSchemasInfo = $opinionSchemasInfo;
        $this->brdcArchiveInfo = $brdcArchiveInfo;
        $this->brdcRssInfo = $brdcRssInfo;
        $this->rssSchemasInfo = $rssSchemasInfo;
    }
    ...
    public function render(): View|Closure|string
    {
        ...
        $customCodeData = Setting::select('details')->where('event','custom_code')->first();
        $customCode = json_decode($customCodeData->details);
