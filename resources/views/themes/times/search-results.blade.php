        ...
        <section class="md:col-span-2 xl:col-span-3 gap-6">
            ...
            @else
                            ...
                            @foreach ($firstSixNews as $news)
                                <div class="">
                                    <a href="{{ __url($news->encode_title) }}"
                                        class="block w-full h-42 md:h-[150px] 2xl:h-40 4xl:h-52 group overflow-hidden relative">
                                        <img class="w-full h-full object-cover group-hover:scale-105 transition_5"
                                            ...
                                            alt="{{ $news->image_alt }}" />
                                        <div class="h-7 pl-3 pr-6 text-xs text-white uppercase flex justify-center items-center clip-hex-right absolute top-3 right-3 z-10"
                                            {!! bgColorStyle($news->category->color_code) !!}>
                ...
                @if ($secondSixNews->isNotEmpty())
                    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-8 mt-6">
                        <!-- cart -->
                            ...
                            <div class="">
                                <a href="{{ __url($news->encode_title) }}"
                                    ...
                                    <img class="w-full h-full object-cover group-hover:scale-105 transition_5"
                                        ...
                                        alt="{{ $news->image_alt }}" />
                                    <div
                                        class="h-7 pl-3 pr-6 text-sm text-white uppercase flex justify-center items-center clip-hex-right absolute top-3 right-3 z-10"
                                        {!! bgColorStyle($news->category->color_code) !!}>
                                        {{ $news->category->category_name }}
                                    </div>
                                </a>
                ...
                @if ($remainingNews->isNotEmpty())
                    <section class="my-8">
                        <!-- Card section -->
                        <div id="news-grid" class="relative grid md:grid-cols-2 xl:grid-cols-3 gap-8">
                            <!-- cart -->
