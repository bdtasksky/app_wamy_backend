<x-web-layout :seoSchemasInfo="$newsDetail">
    ...
    <section class="container mt-2">
        <div class="bg-neutral-100 dark:text-white dark:bg-neutral-800 flex items-center p-2 gap-3">
            <ul class="flex gap-1 items-center">
                <li>
                    <a class="text-neutral-600 dark:text-white transition_3 capitalize whitespace-nowrap" href="{{ __url('/') }}">{{ localize('home') }}</a>
                </li>
    ...
    <section class="container mt-2 pb-8 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 4xl:grid-cols-4 gap-4">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <div class="">
                ...
                <div class="flex md:items-center justify-between flex-col md:flex-row gap-4 mt-4">
                    ...
                    <!-- Social section -->
                    @include ('themes.times.components.common.social-section')
                </div>
            </div>
            <!-- News Details -->
                ...
                @if (isset($newsDetail->photoLibrary->large_image))
                    <figure class="mb-8">
                        <img class="w-full max-h-[550px]"
                            src="{{ isset($newsDetail->photoLibrary->large_image) ? asset('storage/'.$newsDetail->photoLibrary->large_image) : asset('/assets/details-lg-image.png') }}"
        ...
        <section>
            ...
            <!-- Popular post -->
            @include('themes.times.components.common.popular-post')
    ...
    <section class="container mt-2 pb-8 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 4xl:grid-cols-4 gap-4">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <!-- Article-slider -->
            @include ('themes.times.components.slider.article-slider')
            ...
            @if ($sectionSixNews->isNotEmpty())
                @include ('themes.times.components.common.related-post')
            @endif
            ...
            @if (app_setting()->web_user_can_comment == 1)
                @include ('themes.times.components.details.comment-section')
            @endif
        ...
        <section >
            ...
            <!-- Voting poll -->
            @if ($votingPoll)
                @include('themes.times.components.common.voting-poll')
            @endif
            <!-- Ads section -->
            <figure class="">
                @php $ad = get_advertisements(3, 4); @endphp
