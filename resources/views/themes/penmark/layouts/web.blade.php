...
<body class="min-h-screen relative" @if (!$themeSettings->is_default &&
	...
	@include('themes.penmark.components.common.login')
	{{-- Side Menu section --}}
	@include('themes.penmark.layouts.header.side-menu')

	<!-- Top Section -->
	@include('themes.penmark.layouts.header.top-section')
	{{-- Menu section --}}



	<div class="mt-16">
		@include ('themes.penmark.layouts.header.mobile-menu')
		{{ $slot }}
	</div>

	<!-- Footer section -->
	@include('themes.penmark.layouts.footer')

	<!-- Cookies section -->
	@if ($cookieInfo->show_cookie == 1)
	 	@include('themes.penmark.components.common.cookies')
	@endif
