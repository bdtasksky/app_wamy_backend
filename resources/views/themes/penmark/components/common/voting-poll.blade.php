         ...
         <form class="p-3 pt-1.5 space-y-2 dark:text-white">
             ...
             <section class="space-y-2 votiong_question">
                 ...
                 <div class="space-x-2">
                     ...
                     <button type="button"
                         class="btn_result dark:text-white text-lg p-1.5 hover:text-sky-600 dark:hover:text-sky-600 transition_3">
             ...
             <section class="voting_result_section hidden">
                 ...
                 <button type="button"
                     class="btn_option dark:text-white text-lg p-1.5 hover:text-sky-600 dark:hover:text-sky-600 font-semibold transition_3">
