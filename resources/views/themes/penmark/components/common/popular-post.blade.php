<section
    class="border p-2 2xl:p-3 rounded-md order-3 dark:bg-neutral-900 dark:divide-neutral-700 dark:border-neutral-800 shadow-sm">
        ...
        @foreach ($popularNews as $popularNewsItem)
            <div class="py-3 flex-1">
                <a href="{{ __url($popularNewsItem->encode_title) }}"
                    class="text-lg font-bold line-clamp-2 dark:text-neutral-50 text-neutral-800 hover:text-sky-600 dark:hover:text-sky-600 transition_3">
                    {{ $popularNewsItem->title }}
                </a>
                <p class="text-neutral-600 dark:text-neutral-50 mt-2 text-sm line-clamp-2">
