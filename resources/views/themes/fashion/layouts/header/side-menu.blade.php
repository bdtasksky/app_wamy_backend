...
<div id="mobileMenuModal" class="fixed inset-0 z-50 bg-black bg-opacity-60 hidden">
    <!-- Sidebar -->
    <div class="side-bar bg-[#1b060e] dark:bg-[#0e0307] h-full p-6 pt-2 overflow-x-hidden overflow-y-auto shadow-md side_bar" id="sidebar">
        <!-- Close Button -->
        ...
        <!-- Login / Registration -->
        @include('themes.fashion.components.common.login-button-sm')
        ...
        @if ($languages->count() > 1)
            <div class="relative inline-block mt-6">
                <button type="button" id="dropdownButton"
                    class="text-white bg-theme-six-secondary transition_3 px-4 py-1.5 rounded-md">
