<x-web-layout :seoSchemasInfo="$newsDetail">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <div class="">
                ...
                <div class="flex md:items-center justify-between flex-col md:flex-row gap-4 mt-2">
                    ...
                    <!-- Social section -->
                    @include ('themes.gazette.components.common.social-section')
                </div>
            </div>
            <!-- News Details -->
    ...
    <section class="container mt-2 pb-8 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 4xl:grid-cols-4 gap-4">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <!-- Article-slider -->
            @include ('themes.gazette.components.slider.article-slider')
            ...
            @if ($sectionSixNews->isNotEmpty())
                @include ('themes.gazette.components.common.related-post')
            @endif
            ...
            @if (app_setting()->web_user_can_comment == 1)
                @include ('themes.gazette.components.details.comment-section')
            @endif
