<div class="lg:flex justify-between gap-4 mb-4">
    ...
    <a href="{{ __url($sectionTwoNews['leftNews'][0]->category->slug) }}"
...
<section id="newsGrid" class="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    @foreach ($sectionTwoNews['leftNews'] as $sectionTwoNewsLeftItem)
        <div class="border dark:border-neutral-700 hover:border-sky-600 transition_3 hover:-translate-y-2 group relative">
            <a href="{{ __url($sectionTwoNewsLeftItem->news->encode_title) }}"> 
