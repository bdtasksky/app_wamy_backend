...
<div class="hidden xl:block">
    ...
    @else
        <!-- Login / Registration (icon only) -->
        <div class="flex items-center dark:text-white">
            <button type="button" id="openModal" class="transition_3 btn_theme bg-neutral-100 dark:bg-theme-six-secondary text-orange-600 dark:text-white w-9 h-9 flex justify-center items-center rounded-full border dark:border-neutral-800">
                <!-- Heroicons user icon -->
