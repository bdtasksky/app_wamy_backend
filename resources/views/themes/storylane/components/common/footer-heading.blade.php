<div class="flex items-center justify-between gap-4 py-8">
    <a class="w-44 md:w-64 h-11 overflow-hidden" href="{{ __url('/') }}">
    ...
    <div class="flex gap-2 md:gap-4">
        <a target="_blank"
            ...
            href="{{ $socialLinks->fb->link ?? 'https://www.facebook.com' }}" aria-label="{{ localize('visit_our_facebook_page') }}">
        ...
        <a target="_blank"
            ...
            href="{{ $socialLinks->tw->link ?? 'href="https://www.twitter.com/' }}" aria-label="{{ localize('visit_our_twitter_page') }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a target="_blank"
            ...
            href="{{ $socialLinks->instagram->link ?? 'href="https://www.instagram.com/' }}" aria-label="{{ localize('visit_our_instagram_page') }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a target="_blank"
            ...
            href="{{ $socialLinks->youtube->link ?? 'href="https://www.youtube.com/' }}" aria-label="{{ localize('visit_our_youtube_channel') }}">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
