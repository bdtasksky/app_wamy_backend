...
<div class="search_wrapper relative">
    <button type="button"
        class="btn_search w-9 h-9 leading-[40px] border xl:border-white dark:border-neutral-800 flex justify-center items-center rounded-full text-neutral-600 dark:text-neutral-50 xl:text-white bg-neutral-100 dark:bg-theme-six-secondary xl:bg-theme-six-primary dark:xl:bg-theme-six-primary/50">
