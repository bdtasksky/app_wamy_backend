...
<body class="min-h-screen relative" @if (!$themeSettings->is_default &&
	...
	@include('themes.storylane.components.common.login')
	{{-- Side Menu section --}}
	@include('themes.storylane.layouts.header.side-menu')

	<!-- Top Section -->
	@include('themes.storylane.layouts.header.top-section')

	<div class="mt-16">
		@include ('themes.storylane.layouts.header.mobile-menu')
		{{ $slot }}
	</div>


	<!-- Footer section -->
	@include('themes.storylane.layouts.footer')

	<!-- Cookies section -->
	@if ($cookieInfo->show_cookie == 1)
		@include('themes.storylane.components.common.cookies')
	@endif
