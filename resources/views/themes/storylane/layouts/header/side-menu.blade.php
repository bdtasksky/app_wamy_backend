...
<div id="mobileMenuModal" class="fixed inset-0 z-50 bg-black bg-opacity-60 hidden">
    <!-- Sidebar -->
    <div class="side-bar bg-neutral-950 h-full p-6 pt-2 overflow-x-hidden overflow-y-auto shadow-md side_bar" id="sidebar">
        <!-- Close Button -->
        ...
        @if ($languages->count() > 1)
            <div class="relative inline-block mt-6">
                <button type="button" id="dropdownButton"
                    class="text-white bg-neutral-700 transition_3 px-4 py-1.5 rounded-md">
