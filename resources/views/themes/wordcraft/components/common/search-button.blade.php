...
<div class="search_wrapper relative">
    <button type="button"
        class="btn_search w-9 h-9 leading-[40px] border xl:border-white dark:border-neutral-800 flex justify-center items-center rounded-full text-neutral-600 dark:text-neutral-50 xl:text-white bg-neutral-100 dark:bg-theme-six-secondary xl:bg-sky-600">
    ...
    <form action="{{ __url('search') }}" method="GET"
        ...
        <button type="submit"
            class="w-9 h-[40px] leading-[40px] flex justify-center items-center text-white bg-neutral-800 xl:bg-sky-600 dark:bg-neutral-600 absolute right-0 top-0 rtl:right-auto rtl:left-0">
            <!-- SVG here -->
