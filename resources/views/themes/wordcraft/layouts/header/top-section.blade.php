...
<section
    ...
    <div class="container mx-auto py-2 flex justify-between items-center">
        ...
        @include('themes.wordcraft.layouts.header.menu')
        ...
        <section class="flex items-center gap-2 xl:gap-2">
            ...
            <!-- Login / Registration -->
            @include('themes.wordcraft.components.common.login-button')
            ...
            <!-- Search button -->
            <div class="xl:hidden">
                @include('themes.wordcraft.components.common.search-button')
            </div>
