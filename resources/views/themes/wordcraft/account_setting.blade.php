    ...
    <section class="container mt-16 lg:my-6">
        ...
        <div class="dark:text-white bg-neutral-100 dark:bg-neutral-800 flex items-center p-2 gap-3">
            <ul class="flex gap-1 items-center">
                <li>
                    <a class="text-neutral-600 dark:text-white whitespace-nowrap capitalize transition_3"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 my-4 lg:my-10  2xl:gap-16 space-y-4 lg:space-y-0 lg:gap-4">
            ...
            <div class="col-span-4">
                ...
                @endif
                {{-- update profile --}}
                @include('themes.wordcraft.components.setting.update-profile')

                {{-- delete account --}}
                @include('themes.wordcraft.components.setting.delete-account')
            </div>
        </div>
