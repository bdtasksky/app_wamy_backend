<x-web-layout :seoSchemasInfo="$newsDetail">
    ...
    <section class="container mt-2 pb-8 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 4xl:grid-cols-4 gap-4">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <div class="dark:text-white">
                <div class="bg-white dark:bg-neutral-800 mb-6">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        @endif
                        <h2 class="dark:text-white mt-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fugiat, laboriosam.</h2>
                        ...
                        <div class="flex md:items-center justify-between flex-col md:flex-row gap-4 mt-4">
                            ...
                            <!-- Social section -->
                            @include ('themes.wordcraft.components.common.social-section')
                        </div>
                    </div>
                </div>
                {{-- News Details --}}
    ...
    <section class="container mt-2 pb-8 grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 4xl:grid-cols-4 gap-4">
        ...
        <section class="lg:col-span-2 xl:col-span-2 4xl:col-span-3 gap-6">
            ...
            <!-- Article-slider -->
            @include ('themes.wordcraft.components.slider.article-slider')
            ...
            @if ($sectionSixNews->isNotEmpty())
                @include ('themes.wordcraft.components.common.related-post')
            @endif
            ...
            @if (app_setting()->web_user_can_comment == 1)
                @include ('themes.wordcraft.components.common.comment-section')
            @endif
