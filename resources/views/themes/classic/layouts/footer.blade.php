<footer class="relative w-full h-max isolate @if (!$themeSettings->footer_color || mode()) bg-theme-six-secondary @endif"
    ...
    <div class="container py-8">
        @include ('themes.classic.components.common.footer-heading')

        <section
            class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 xl:gap-0 border-y border-y-neutral-700 py-8 lg:divide-x lg:divide-neutral-700 lg:rtl:divide-x-reverse">
            <!--  {/* Address Section */} -->
