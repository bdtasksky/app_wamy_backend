        ...
        <nav class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li
                    ...
                    <a class="has-arrow material-ripple" href="#">
                        <i class="fa fa-newspaper"></i> {{-- or fa-blog, fa-pen, whatever you prefer --}}
                        <span>{{ localize('website') }}</span>
                    </a>

                    {{-- show submenu if ANY blog-related URL matches --}}
                    <ul
                        class="nav-second-level {{ request()->is('admin/news*') || request()->is('admin/photo-library*') || request()->is('admin/category*') || request()->is('admin/videonews*') ? 'mm-show' : '' }}">
                        @can('read_theme')
                        ...
                        @can('read_category')
                            <li class="{{ request()->is('admin/category*') ? 'mm-active' : '' }}">
                                ...
                                <ul class="nav-second-level {{ request()->is('admin/category*') ? 'mm-show' : '' }}">
                                    <li
                                        class="{{ request()->is('admin/category/list_of_categories') ? 'mm-active' : '' }}">
                                        <a class="dropdown-item"
                        ...
                        @can('read_rss_feeds')
                            <li class="{{ request()->is('admin/rss_feeds*') ? 'mm-active' : '' }}">
                                ...
                                @can('read_external_rss_feeds')
                                    <ul
                                        class="nav-second-level {{ request()->is('admin/external_rss_feeds*') ? 'mm-show' : '' }}">
                                        <li
                                            class="{{ request()->is('admin/rss_feeds/external-rss-feeds') ? 'mm-active' : '' }}">
                                            <a class="dropdown-item"
                        ...
                        @can('read_seo')
                            ...
                            @endcan --}}
                                    ...
                                    @can('read_custom_code')
                                        <li class="{{ request()->is('admin/seo/custom-code') ? 'mm-active' : '' }}">
                                            <a class="dropdown-item"
                                                href="{{ route('seo.custom.code') }}">{{ ucwords(localize('custom_code')) }}</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
                            ...
                            <li class="{{ request()->is('admin/web-setup*') ? 'mm-active' : '' }}">
                                ...
                                <ul class="nav-second-level {{ request()->is('admin/web-setup*') ? 'mm-show' : '' }}">
                                    @can('read_setup_top_breaking_post')
                                        <li
                                            class="{{ request()->is('admin/web-setup/setup-top-breaking') ? 'mm-active' : '' }}">
                                            <a class="dropdown-item"
                                    ...
                                    @can('read_home_page')
                                        <li
                                            class="{{ request()->is('admin/web-setup/home-page-settings') ? 'mm-active' : '' }}">
                                            <a class="dropdown-item"
                                    ...
                                    @can('read_contact_page_setup')
                                        <li
                                            class="{{ request()->is('admin/web-setup/contact-page-setup') ? 'mm-active' : '' }}">
                                            <a class="dropdown-item"
                ...
                {{-- <li class="{{ request()->is('admin/update/guides') ? 'mm-active' : '' }}">
                    <a href="{{ route('update.guides') }}">
                        ...
                        <span>{{ localize('update_guides') }}</span>
                    </a>
                </li> --}}
            </ul>
        </nav>
