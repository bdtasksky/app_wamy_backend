                ...
                <div class="col-md-8">
                    ...
                    <div class="accordion mt-4" id="changelogAccordion">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-704">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-704" aria-expanded="true" aria-controls="collapse-704">
                                    <h6 class="mb-0">Version: <span class="badge bg-success">v7.0.4</span></h6>
                                </button>
                            </h2>
                            <div id="collapse-704" class="accordion-collapse collapse show" aria-labelledby="heading-704" data-bs-parent="#changelogAccordion">
                                <div class="accordion-body">
                                    <h6>Changelog:</h6>
                                    <ul>
                                        <li>Introduced <strong>dynamic permalink structure</strong> — supports <code>default</code>, <code>category</code>, and <code>date</code> formats.</li>
                                        <li>Kept <strong>original image names</strong> during upload for better SEO and file management.</li>
                                        <li>Added <strong>Remove Trailing Slash</strong> middleware to standardize URLs.</li>
                                        <li>Implemented <strong>unpublished post preview</strong> feature for editors.</li>
                                        <li>Enhanced <strong>publish date control</strong> — automatically synced with post updates.</li>
                                        <li>Updated <strong>sitemap link structure</strong> to match dynamic permalinks.</li>
                                        <li>Resolved several <strong>SEO and routing issues</strong> (canonical URLs, meta consistency, and path resolution).</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        {{-- Version 7.0.3 --}}
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-703">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-703" aria-expanded="true" aria-controls="collapse-703">
                                    <h6 class="mb-0">Version: <span class="badge bg-primary">v7.0.3</span></h6>
                                </button>
                            </h2>
                            <div id="collapse-703" class="accordion-collapse collapse" aria-labelledby="heading-703" data-bs-parent="#changelogAccordion">
                                <div class="accordion-body">
                                    <h6>Changelog:</h6>
                                    <ul>
                                        <li>
                                            Added 3 new blog themes:
                                            <ol class="mt-1 mb-1">
                                                <li>
                                                    <span class="badge bg-secondary">Penmark</span> — A clean, modern blog theme ideal for writers and thought pieces.
                                                </li>
                                                <li>
                                                    <span class="badge bg-secondary">Storylane</span> — A storytelling-focused theme, perfect for personal or lifestyle blogs.
                                                </li>
                                                <li>
                                                    <span class="badge bg-secondary">Wordcraft</span> — A bold, content-first theme designed for creative bloggers.
                                                </li>
                                            </ol>
                                        </li>
                                        <li>Fixed thumbnail image rendering issues.</li>
                                        <li>Implemented enable/disable option for cookie alert.</li>
                                        <li>Introduced a dynamic section to inject custom code in the website header.</li>
                                        <li>Added dynamic enable/disable option for advertisements.</li>
                                        <li>Resolved URL breaking issues and enhanced SEO schema handling with dynamic generation support.</li>
                                        <li>Fixed several minor bugs and layout issues across the application.</li>
                                    </ul>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="heading-702">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-702" aria-expanded="true" aria-controls="collapse-702">
                                    <h6 class="mb-0">Version: <span class="badge bg-primary">v7.0.2</span></h6>
                                </button>
                            </h2>
                            <div id="collapse-702" class="accordion-collapse collapse" aria-labelledby="heading-702" data-bs-parent="#changelogAccordion">
                                <div class="accordion-body">
                                    <h6>Changelog:</h6>
                                    <ul>
